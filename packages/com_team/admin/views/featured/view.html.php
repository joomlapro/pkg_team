...
/**
 * View class for a list of featured users.
 *
 * @package     Team
 * @subpackage  com_team
 * @author      Bruno Batista <bruno@atomtech.com.br>
 * @since       3.2
 */
class TeamViewFeatured extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		{
			// Load the submenu.
			TeamHelper::addSubmenu('featured');
	...
	protected function addToolbar()
	{
		...
		$canDo = UsersHelper::getActions($this->state->get('filter.category_id'), 0, 'com_team');
		$user  = JFactory::getUser();

		JToolbarHelper::title(JText::_('COM_TEAM_MANAGER_FEATURED_TITLE'), 'star featured');
